    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <h1 class="mb-5 pt-2 titulo">Regulariza MEI</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('tomadores.planos.storeMei') }}" method="POST"
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="pricing-container pt-5">
                                        <div class="pricing-card">
                                            ...
                                            <p class="price">R$ {{ $meiMensal }}</p>
                                            <p><small>Valor Anual: R$ {{ $meiAnual }}</small></p>
                                            <ul>
